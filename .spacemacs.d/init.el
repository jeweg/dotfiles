...
;; Reloading this config: <SPC f e R>
...
(defun dotspacemacs/user-config ()
  ...
  (setq c-default-style "bsd" ; aka Allman style, see https://en.wikipedia.org/wiki/Indent_style
        c-basic-offset 4)
  ...
  (blink-cursor-mode t)
  (setq blink-cursor-interval 0.38)
  (setq x-stretch-cursor t)

  ;; From http://stackoverflow.com/a/20899418
  ...
  ;; TODO: dash/zeal still doesn't work...
